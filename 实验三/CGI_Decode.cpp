// CGI_Decode.cpp : Defines the entry point for the console application.
//
 ...
 */
int decode(const char *encoded, char *decoded)
{
...
{
	int ok;
	const char *input = "https://example.com/search?q=Hello+World%20Test%25%2F%4aEnd"; /*This is a test case*/
